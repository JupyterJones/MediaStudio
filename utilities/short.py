...
DB_FILE = "analysis_results5.sqlite3"
LOG_FILE_PATH = "analysis5.log"
...
""".strip()
            ...
            summary = raw if raw else f"{u['unit_type']} {u['name']}"

            self.db.mark_analyzed(u["unit_id"], summary, raw)
